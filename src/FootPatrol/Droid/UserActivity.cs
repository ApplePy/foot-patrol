...
namespace FootPatrol.Droid
{
    ...
    public class UserActivity : Android.Support.V4.App.Fragment, GoogleApiClient.IOnConnectionFailedListener, GoogleApiClient.IConnectionCallbacks, Android.Gms.Location.ILocationListener, IOnMapReadyCallback
    {
        ...
        public override Android.Views.View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            "SEB - SPENCER ENGINEERING BUILDING", "SH - SOMERVILLE HOUSE", "SSC - SOCIAL SCIENCES CENTRE", "STVH - STEVENSON HALL", "TC - TALBOT COLLEGE", "TEB - THOMPSON ENGINEERING BUILDING", "TH - THAMES HALL", "UC - UNIVERSITY COLLEGE", "UCC - UNIVERSITY COMMUNITY CENTRE",
